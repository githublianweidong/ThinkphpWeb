function att_show(serverData,file)
{
	...
	var filename = data[3];
	if(id == 0) {
		window.top.art.dialog.alert(src);
		return false;
	}
	if(ext == 1) {
		var img = '<a href="javascript:;" onclick="javascript:att_cancel(this,'+id+',\'upload\')" class="on"><div class="icon"></div><img src="'+src+'" width="80" imgid="'+id+'" path="'+src+'" title="'+filename+'"/></a><div class="tit-img"><input class="img-title" value="" onblur="retitle(this)" data-id="'+id+'"/></div>';
	} else {
