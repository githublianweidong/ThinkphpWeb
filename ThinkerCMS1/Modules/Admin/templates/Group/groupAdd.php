...
<table width="100%" class="table_form contentWrap">
      <tr>
        <th width="80">分组名称：</th>
        <td><input type="text" name="info[title]" id="title" class="input-text" value=""></td>
      </tr>  
	  <tr>
        <th>状态：</th>
        <td><input type="radio" name="info[status]" value="1" checked> 启用<input type="radio" name="info[status]" value="0"> 禁用</td>
      </tr>
</table>	  
<!--table_form_off-->
